        ...
        if (targetEntity instanceof LivingEntity livingTarget) {
            ...
            if(Objects.equals(MoreMagic.Magic_Name, "Stupefy")){
                ...
                if (minecraftClient.world != null) {
                    livingTarget.damage(new DamageSources(minecraftClient.world.getRegistryManager()).create(DamageTypes.GENERIC,projectile.getOwner()), (float) (3F+ThisPlayer.experienceLevel*0.2));
                ...
                livingTarget.damage(new DamageSources(minecraftClient.world.getRegistryManager()).create(DamageTypes.GENERIC,projectile.getOwner()), (float) (1.5F+ThisPlayer.experienceLevel*0.15));
                ...
                double knockbackDirectionZ = -(livingTarget.getZ() - projectile.getZ());
                livingTarget.takeKnockback(knockbackStrength, knockbackDirectionX, knockbackDirectionZ);
                livingTarget.damage(new DamageSources(minecraftClient.world.getRegistryManager()).create(DamageTypes.GENERIC,projectile.getOwner()), (float) (0.5F+ThisPlayer.experienceLevel*0.1));
