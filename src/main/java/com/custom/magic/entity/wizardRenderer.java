...
public class wizardRenderer extends MobEntityRenderer<MagicVillager, VillagerResemblingModel<MagicVillager>> {
    public static final Identifier TEXTURE = new Identifier("magic","textures/entity/wizard.png");
